"""
Django settings for red_smoke_39331 project.
...
ROOT_URLCONF = 'red_smoke_39331.urls'
...
WSGI_APPLICATION = 'red_smoke_39331.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_smoke_39331 API",
    "DESCRIPTION": "API documentation for red_smoke_39331 App",
    "VERSION": "v1",
}
